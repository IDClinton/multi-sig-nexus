...
import { Plus, Wallet, Users, Shield, TrendingUp, Copy } from 'lucide-react';
      ...
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center max-w-md mx-auto p-8">
          ...
          <p className="text-muted-foreground mb-6">
            Connect your MetaMask wallet to access your multi-signature wallets and start managing transactions securely.
          </p>
        </div>
      </div>
    );
    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-3xl font-bold mb-2">Multi-Sig Dashboard</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <Card className="shadow-card border-border/50">
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {wallets.reduce((sum, wallet) => sum + parseFloat(wallet.balance), 0).toFixed(2)} ETH
              </div>
              <p className="text-xs text-muted-foreground">
          ...
          <Card className="shadow-card border-border/50">
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {wallets.reduce((sum, wallet) => sum + wallet.owners.length, 0)}
              </div>
              <p className="text-xs text-muted-foreground">
                Across all wallets
              </p>
        ...
        {wallets.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-muted-foreground mb-6 max-w-md mx-auto">
              Create your first multi-signature wallet to start managing transactions with enhanced security.
            </p>
            <CreateWalletModal 
              trigger={
                <EnhancedButton variant="gradient" size="lg" className="gap-2">
